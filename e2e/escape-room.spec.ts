...
// TODO: Add hangar bay E2E tests once the Corridor scene (puzzle 3) is implemented.
// E2E tests must replicate real user behavior and cannot depend on internal state
// manipulation. Currently, players cannot reach the hangar bay without implementing
// the corridor scene first, so these tests are deferred until feat/scene-corridor lands.
