...
Quick reference for web application security. Use alongside the `security-audit` skill.
...
- [ ] MFA supported for sensitive operations (optional)
...
- [ ] All user input validated at system boundaries (API routes, forms)
